...
* @Last Modified by:   浣曞啿
* @Last Modified time: 2017-03-30 18:02:58
*/
...
//页面内容拖放
    ...
    function addTransition(){
    	smbox.style.transition="all 0.5s  ease 0s"
    	smbox.style.webkitTansition="all 0.5s  ease 0s"
    }
    function removeTransition(){
    	smbox.style.transition="all 0s  ease 0s"
